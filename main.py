...
for idx in tqdm(range(len(sample_list))):
    ...
    print("Running depth extraction at " + str(time.time()))
    ...
    if not (config['load_ply'] is True and os.path.exists(mesh_fi)):
        ...
        print("Loading edge model at " + str(time.time()))
        ...
        print("Loading depth model at " + str(time.time()))
        ...
        depth_feat_model = depth_feat_model.to(device)
        print("Loading rgb model at " + str(time.time()))
        ...
        print("Writing depth ply (and basically doing everything) at " + str(time.time()))
    ...
    print("Making video at " + str(time.time()))
